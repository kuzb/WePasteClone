...
<!doctype html>
	...
	<body>
		...
		<div class="success">
			<b>You are in the look only mode of the history! </b>
			<em><small>Click on the edit button below to start editing the last known version</small></em>
		</div>
		<section class="note" data-role="content" data-theme="c">
			...
			<form method="post" action="" name="note">
				...
				<input type="submit" name="go" class="button" method="post" value="Edit Last Known Version" style="margin-right:0;">
		...
		<div id="history" style="display:none;">
			<ul class="history">
				<?php while($save = mysqli_fetch_assoc($mysqli_saves)){
					echo "<li><a name = ".$save["SaveDate"].">" .$save["SaveDate"]. "</a></li>";
				} ?>
			</ul>
		</div>
